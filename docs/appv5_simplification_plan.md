...
6. **Tk UI retirement** – the legacy Tkinter widgets (`ScrollableFrame`, `App`) have been removed alongside the `cad_quoter/ui/` package now that the desktop launcher no longer ships in this repository.

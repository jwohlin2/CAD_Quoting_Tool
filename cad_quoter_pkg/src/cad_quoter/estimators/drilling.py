"""Drilling estimator helpers and entrypoint reused from the legacy implementation."""
...
from cad_quoter.estimators.base import EstimatorInput, SpeedsFeedsUnavailableError
...
def _resolve_speeds_feeds_table(
...
def estimate(input_data: EstimatorInput) -> float:
    ...
    return _legacy_estimate_drilling_hours(
        hole_diams_mm,
        thickness_in,

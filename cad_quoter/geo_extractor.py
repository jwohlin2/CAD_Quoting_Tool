...
_GEO_DRILL_RADIUS_MIN_DEFAULT = max(_GEO_DIA_MIN_IN / 2.0, 0.0)
_GEO_DRILL_RADIUS_MIN_IN = max(
    _env_float("GEO_DRILL_RADIUS_MIN_IN", default=_GEO_DRILL_RADIUS_MIN_DEFAULT),
    0.0,
)

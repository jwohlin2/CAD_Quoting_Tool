...
def _ensure_geometry_helpers() -> None:
    ...
    defaults: Dict[str, object] = {
        ...
        "extract_features_with_occ": _return_empty_dict,
        ...
        "linear_properties": _return_empty_dict,
        "map_shapes_and_ancestors": _return_empty_dict,
        "HAS_TRIMESH": False,
        "HAS_EZDXF": False,
        "HAS_ODAFC": False,

...
def _compute_material_block(
    ...
    try:
        ...
        pass
    stock_price = _coerce_float_or_none(stock_info.get("price$"))
    total_mat_cost = round(start_lb * price_per_lb, 2)
    if stock_price is not None and stock_price > 0:
        total_mat_cost = float(stock_price)

    supplier_min = _coerce_float_or_none(stock_info.get("supplier_min$")) or 0.0
